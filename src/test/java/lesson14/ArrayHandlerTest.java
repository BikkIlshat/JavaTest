...
public class ArrayHandlerTest {
    ...
    @ParameterizedTest
    @MethodSource ("dataForSuccessGetValuesAfterLastFour")
    ...
    private static Stream<Arguments> dataForSuccessGetValuesAfterLastFour () {
    ...
    @Test
    public void checkingTheArrayForTheAbsenceOfFours() {
    ...
    private static Stream<Arguments> dataForFindFourOrOneNumberInArray (){
        List<Arguments> arguments  = new ArrayList<Arguments>() {{
            ...
            add(Arguments.arguments(new int[]{1,1,1,4,4,1,4,3}, false));
